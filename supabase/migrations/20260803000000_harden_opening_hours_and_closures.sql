-- Les réservations du club utilisent des créneaux fixes d'une heure.
...
-- Répare et complète les commandes utilisées par l'onglet Fermetures.
...
-- Une commande de réservation ne peut plus contourner les horaires affichés.
