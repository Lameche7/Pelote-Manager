...
-- Cette fonction destructive est destinée exclusivement à l'éditeur SQL Supabase.
-- Elle n'est plus exécutable depuis l'application, même par un compte administrateur.
