  ...
  return (
    <span className={`club-logo ${compact ? "club-logo--compact" : ""} ${className}`.trim()}>
      <svg viewBox="0 0 120 138" role="img" aria-label="Pelotaris Club Lourdais">
        ...
        <path d="M55 54c3 1 6 3 9 6M55 60c3-1 6-3 9-6" fill="none" stroke="#d62828" strokeWidth="1.5" />
        {!compact && (
          <>
            <text x="60" y="105" textAnchor="middle" fontSize="9" fontWeight="800" fill="#0d2b6c">
              PELOTARIS CLUB
            </text>
            <text x="60" y="116" textAnchor="middle" fontSize="10" fontWeight="900" fill="#d62828">
              LOURDAIS
            </text>
            <text x="60" y="127" textAnchor="middle" fontSize="8" fontWeight="800" fill="#0d2b6c">
              1957
            </text>
          </>
        )}
