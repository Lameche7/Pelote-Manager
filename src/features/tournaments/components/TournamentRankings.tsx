import type {
  TournamentGeneralRankingTeam,
  TournamentGeneralRankings,
...
type Props = {
  ...
  generalRankings?: TournamentGeneralRankings | null;
  compact?: boolean;
};
...
const generalValueLabel = (
  team: TournamentGeneralRankingTeam,
  rankings: TournamentGeneralRankings,
) =>
  rankings.rankingMode === "points_per_match"
    ? numberFormatter.format(team.rankingValue)
    : String(team.rankingPoints);

const generalGoalAverageLabel = (
  team: TournamentGeneralRankingTeam,
  rankings: TournamentGeneralRankings,
) =>
  rankings.goalAverageMode === "point_difference_per_match"
                  ...
                  {generalSeries && (
                    <article className="tournament-ranking-pool">
                      <header>
                        ...
                        <span>
                          {generalSeries.validatedMatches}/
                          {generalSeries.totalMatches} résultat
                          {generalSeries.totalMatches > 1 ? "s" : ""} validé
                          {generalSeries.validatedMatches > 1 ? "s" : ""}
                        </span>
                      </header>
